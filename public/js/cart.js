            ...
            !(function(t, e) {
                    ...
                    _init: function() {
                        ...
                        if (
                            ...
                            for (
                                ...
                                (this.shuffledIndexes[p] = this.shuffledIndexes[
                                    f
                                ]),
                                ...
                                if (!1 !== this.isThumbnailScroller) {
                                    ...
                                    "horizontal" === this.thumbnailsOrientation
                                        ...
                                        this.settings.thumbnailsPosition
                                            ...
                                            ? this.$slider.css({
                                                  paddingTop: "",
                                                  paddingLeft: this.$thumbnailsContainer.outerWidth(
                                                      !0
                                                  ),
                                                  paddingRight: ""
                                              })
                    ...
                    var i = "ConditionalImages." + e.SliderPro.namespace,
                        s = {
                            ...
                            initConditionalImages: function() {
                                (this.currentImageSize = this.previousImageSize =
                                    "default"),
                                    (this.isRetinaScreen =
                    ...
                    var i = "Layers." + e.SliderPro.namespace,
                        s = {
                            ...
                            _layersGotoSlide: function(t) {
                                var e = this,
                                    s = this.slides[this.selectedSlideIndex]
                                        .animatedLayers;
                                ...
                                1 === e && t.attr("data-transitioning", !0),
                                    ...
                                    "css-2d" === this.supportedAnimation
                                        ? (setTimeout(function() {
                                          ...
                                          t.on(this.transitionEvent, function(
                                              e
                                          ) {
                                              e.target === e.currentTarget &&
                                ...
                                (this.isFullScreen = !!(
                                    ...
                                    !0 === this.isFullScreen
                                        ? ((this.sizeBeforeFullScreen = {
                                              forceSize: this.settings
                                                  .forceSize,
                                              autoHeight: this.settings
                                                  .autoHeight
                                          }),
                                          this.$slider.addClass(
                                              "sp-full-screen"
                ...
                (function(t) {
                    ...
                    ((u.prototype = new s()).constructor = u),
                        t.VideoController.addPlayer("SublimeVideo", u),
                        (u.isType = function(t) {
                            return !(
                                !t.hasClass("sublime") ||
    ...
    EVdn: function(t, e, i) {
        ...
        !(function(e, i) {
                        ...
                        var e = [
                            ...
                            n = {
                                ...
                                then: function(t, s, n) {
                                    ...
                                    return _.Deferred(function(i) {
                                        e[0][3].add(
                                            r(0, i, y(n) ? n : R, i.notifyWith)
                                        ),
                                            e[1][3].add(r(0, i, y(t) ? t : R)),
                    ...
                    for (l /= 2, h = h || u[3], u = +l || 1; r--; )
                        _.style(t, e, u + h),
                            (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 &&
                                (r = 0),
                            (u /= o);
                    (u *= 2), _.style(t, e, u + h), (i = i || []);
                }
                return (
                    i &&
                        ((u = +u || +l || 0),
                        (n = i[1] ? u + (i[1] + 1) * i[2] : +i[2]),
                        s && ((s.unit = h), (s.start = u), (s.end = n))),
                    n
                );
            }
            var ct = {};
            ...
            function Ct(t, e, i, s, n) {
                ...
                for (d.textContent = "", p = 0; (o = c[p++]); )
                    if (s && _.inArray(o, s) > -1) n && n.push(o);
                    else if (
                        ((h = at(o)),
                        (r = bt(d.appendChild(o), "script")),
                        h && wt(r),
                        i)
                    )
                        for (u = 0; (o = r[u++]); )
            ...
            function Ft(t, e, i, s) {
                ...
                if (
                    ...
                    for (
                        a = (r = _.map(bt(n, "script"), Ht)).length;
                        d < c;
                        d++
                    )
                        (l = n),
                ...
                function t() {
                    if (u) {
                        (h.style.cssText =
                            ...
                            rt.appendChild(h).appendChild(u);
            ...
            _.extend({
                ...
                (_.cssHooks.marginLeft = Xt(v.reliableMarginLeft, function(
                    t,
                    e
                ) {
                    if (e)
            ...
            function de() {
                le &&
                    (!1 === r.hidden && i.requestAnimationFrame
                        ? i.requestAnimationFrame(de)
                        : i.setTimeout(de, _.fx.interval),
                    _.fx.tick());
            }
            function ce() {
                return (
            ...
            function ge(t, e, i) {
                ...
                for (
                    ...
                    if ((s = ge.prefilters[o].call(h, t, u, h.opts)))
                        return (
                            y(s.stop) &&
                                (_._queueHooks(
                                    h.elem,
                ...
                tweeners: {
                    "*": [
                        function(t, e) {
                            ...
                            return dt(i.elem, t, nt.exec(e), i), i;
                        }
                    ]
                },
                        ...
                        return {
                            send: function(n, o) {
                                ...
                                (e = function(t) {
                                    return function() {
                                        e &&
                                            ((e = s = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null),
                                            "abort" === t
                                                ? a.abort()
                                                : "error" === t
            ...
            _.ajaxSetup({
                ...
                _.ajaxPrefilter("json jsonp", function(t, e, s) {
                    ...
                    if (a || "jsonp" === t.dataTypes[0])
                        return (
                            (n = t.jsonpCallback = y(t.jsonpCallback)
                                ? t.jsonpCallback()
                                : t.jsonpCallback),
                            a
                ...
                (v.createHTMLDocument =
                    (((Ye = r.implementation.createHTMLDocument("")
                ...
                (_.parseHTML = function(t, e, i) {
                    return "string" != typeof t
                        ...
                        : ("boolean" == typeof e && ((i = e), (e = !1)),
                          e ||
                              (v.createHTMLDocument
                                  ? (((s = (e = r.implementation.createHTMLDocument(
                                        ""
                    ...
                    position: function() {
                        if (this[0]) {
                            ...
                            return {
                                ...
                                left:
                                    e.left - n.left - _.css(s, "marginLeft", !0)
                            };
                        }
                    },
