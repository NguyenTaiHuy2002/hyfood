/*! For license information please see product_detail.js.LICENSE.txt */
!(function (t) {
    var e = {};
    function i(s) {
        ...
        (function (e) {
            ...
            (s = function (t, e, i, s) {
                var n = [],
                    ...
                    r = function () {
                        ...
                        for (t = n.length - 1; t >= 0; t--)
                            n[t].$blocker &&
                                (n[t].$blocker
                                    .toggleClass("current", !e)
                                    .toggleClass("behind", e),
                                (e = !0));
                    };
                (t.modal = function (e, i) {
                    ...
                    if (
                        ((this.$body = t("body")),
                        (this.options = t.extend({}, t.modal.defaults, i)),
                    ...
                    if ((n.push(this), e.is("a")))
                        if (
                            ...
                            if (((this.$elm = t(r)), 1 !== this.$elm.length))
                                return null;
                    ...
                    (t.modal.prototype = {
                        ...
                        close: function () {
                            n.pop(),
                                this.unblock(),
                                this.hide(),
                                t.modal.isActive() || t(i).off("keydown.modal");
                        },
                        block: function () {
                            this.$elm.trigger(t.modal.BEFORE_BLOCK, [
                                this._ctx(),
                            ]),
                        ...
                        hide: function () {
                            this.$elm.trigger(t.modal.BEFORE_CLOSE, [
                                this._ctx(),
                            ]),
                            ...
                            this.options.doFade
                                ? this.$elm.fadeOut(
                                      this.options.fadeDuration,
                                      function () {
                                          e.$elm.trigger(t.modal.AFTER_CLOSE, [
                                              e._ctx(),
                                          ]);
                                      }
                                  )
                    ...
                    a =
                        (i("0H4L"),
                        {
                            ...
                            showFormReview: function () {
                                t(".js-review").click(function (e) {
                                    if (
                                        (e.preventDefault(),
                                        t(this).hasClass("js-check-login"))
                                    )
                                        return (
                                            r.a.warning(
                            ...
                            processReview: function () {
                                ...
                                e.mouseover(function () {
                                    var s = t(this).attr("data-i");
                                    t("#review_value").val(s),
                                        e.removeClass("active"),
                                        e.each(function (e, i) {
                                            e + 1 <= s &&
                                                t(this).addClass("active");
                                        }),
                                        t("#reviews-text").text(i[s]);
                                }),
                                    t(".js-process-review").click(function (e) {
                                        e.preventDefault();
                                        var i = t(this)
                                            .parents("form")
                                            .attr("action");
                                            ...
                                            t("#form-review")[0].reset(),
                                                ...
                                                e.html &&
                                                    (t(".reviews_list .item")
                                                        .last()
                                                        .remove(),
                                                    t(".reviews_list").prepend(
                                                        e.html
                                                    )),
                                                r.a.success(e.messages);
                                        });
                                    });
                            },
                            showPopupCaptcha: function () {
                                t("#popup-captcha").modal({
                                    escapeClose: !1,
                                    clickClose: !1,
                                    showClose: !1,
                                });
                                ...
                                t(".js-submit-captcha").on(
                                    ...
                                    function (e) {
                                        ...
                                        if (!i)
                                            return (
                                                r.a.warning(
                                                    'Bạn chưa xác nhận "Tôi không phải người máy" kìa!'
                                                ),
                                                !1
                                            );
                                        t.ajax({
                            ...
                            loadCssLazy: function () {
                                "undefined" != typeof CSS && Object(n.a)(CSS);
                            },
                            addFavourite: function () {
                                t(".js-add-favourite").click(function (e) {
                                    e.preventDefault();
                                    var i = t(this).attr("href");
                                    i &&
                                        t
                                            .ajax({ method: "POST", url: i })
                                            .done(function (t) {
                                                r.a.warning(t.messages);
                                            });
                                });
                            },
                            runSlider: function () {
                                t("#my-slider").sliderPro({
                                    width: 660,
                                    height: 400,
                                    arrows: !0,
                                    buttons: !1,
                                ...
                                var e = "mobile" === DEVICE ? 2 : 4;
                                t(".js-product-5").owlCarousel({
                                    items: e,
                                    lazyLoad: !0,
                                    loop: !0,
                                    dots: !1,
                            ...
                            addProductRecently: function () {
                                var e = t("#product-detail").attr("data-id"),
                                    i = localStorage.getItem("products");
                                if (null == i) {
                                    var s = new Array();
                                    s.push(e),
                        ...
                        if (
                            ...
                            for (
                                ...
                                var f = Math.floor(Math.random() * (p + 1)),
                                    m = this.shuffledIndexes[p];
                                (this.shuffledIndexes[p] =
                                    this.shuffledIndexes[f]),
                                    (this.shuffledIndexes[f] = m);
                            }
    ...
    EVdn: function (t, e, i) {
        ...
        !(function (e, i) {
            ...
            (_.Callbacks = function (t) {
                ...
                _.extend({
                    ...
                    when: function (t) {
                        ...
                        if (
                            e <= 1 &&
                            (F(t, o.done(r(i)).resolve, o.reject, !e),
                            "pending" === o.state() || y(n[i] && n[i].then))
                        )
                            return o.then();
                        for (; i--; ) F(n[i], r(i), o.reject);
                        return o.promise();
                    },
                });
            ...
            function ft(t, e) {
                for (var i, s, n = [], o = 0, r = t.length; o < r; o++)
                    (s = t[o]).style &&
                        ...
                        e
                            ? ("none" === i &&
                                  ((n[o] = Z.get(s, "display") || null),
                                  n[o] || (s.style.display = "")),
                              "" === s.style.display && ht(s) && (n[o] = pt(s)))
                            : "none" !== i &&
                              ((n[o] = "none"), Z.set(s, "display", i)));
                for (o = 0; o < r; o++)
                ...
                return (
                    (i =
                        void 0 !== t.getElementsByTagName
                            ...
                            : []),
                    void 0 === e || (e && A(t, e)) ? _.merge([t], i) : i
                );
            }
            function wt(t, e) {
                for (var i = 0, s = t.length; i < s; i++)
            ...
            (_.event = {
                ...
                _.fn.extend({
                    on: function (t, e, i, s) {
                        return kt(this, t, e, i, s);
                    },
                    one: function (t, e, i, s) {
                        return kt(this, t, e, i, s, 1);
                    },
                    off: function (t, e, i) {
                        var s, n;
            ...
            function Nt(t, e) {
                ...
                if (1 === e.nodeType) {
                    if (
                        Z.hasData(t) &&
                        ((o = Z.access(t)), (r = Z.set(e, o)), (h = o.events))
                    )
            ...
            function qt(t, e, i, s) {
                ...
                if (
                    ...
                    return t.each(function (n) {
                        var o = t.eq(n);
                        m && (e[0] = f.call(this, n, o.html())), qt(o, e, i, s);
                    });
                if (
                    c &&
                    ...
                    for (
                        a = (r = _.map(bt(n, "script"), jt)).length;
                        u < c;
                        u++
                    )
                        (l = n),
            ...
            function fe(t, e, i) {
                for (
                    var s,
                        n = (me.tweeners[e] || []).concat(me.tweeners["*"]),
                        o = 0,
                        r = n.length;
                    o < r;
                    o++
            ...
            function me(t, e, i) {
                ...
                for (
                    ...
                    if ((s = me.prefilters[o].call(h, t, d, h.opts)))
                        return (
                            y(s.stop) &&
                ...
                trigger: function (t, e, s, n) {
                    ...
                    if (
                        ...
                        for (o = 0; (a = m[o++]) && !t.isPropagationStopped(); )
                            (p = a),
                                (t.type = o > 1 ? h : c.bindType || g),
                                (u =
                                    (Z.get(a, "events") || {})[t.type] &&
                                    Z.get(a, "handle")) && u.apply(a, e),
                                (u = d && a[d]) &&
                                    u.apply &&
                                    J(a) &&
                            ...
                            n ||
                                ...
                                (d &&
                                    ...
                                    t.isPropagationStopped() &&
                                        p.addEventListener(g, Te),
                                    s[g](),
                                    t.isPropagationStopped() &&
                                        p.removeEventListener(g, Te),
                    ...
                    ajax: function (t, e) {
                        ...
                        function T(t, e, r, a) {
                            ...
                            d ||
                                ...
                                (C.statusText = (e || S) + ""),
                                h
                                    ? v.resolveWith(m, [c, S, C])
                                    : v.rejectWith(m, [C, S, p]),
                                C.statusCode(b),
                                (b = void 0),
                                u &&
            ...
            var s = i("hUol"),
                ...
                o = {
                    ...
                    saveComments: function () {
                        t("body").on("click", ".js-save-comment", function (e) {
                            e.preventDefault();
                            var i = t(this),
                                s = i.closest("form");
                            if ("undefined" != typeof ROUTE_COMMENT) {
                                if (
                                    !i.parents("form").find("textarea").val()
                                        .length
                                )
                                    return (
                                        n.a.warning(
                                            "Nội dung comments không được để trống!"
                                        ),
                                        !1
                                    );
                                t.ajax({
                        ...
                        t("body").on(
                            ...
                            function (e) {
                                ...
                                var i = t(this),
                                    s = i.closest("form"),
                                    n = i.closest(".item"),
                                    o = n.find(".comments-reply");
                                "undefined" != typeof ROUTE_COMMENT &&
                                    t
                                        .ajax({
                                            url: ROUTE_COMMENT,
                                            method: "POST",
                    ...
                    showFormReply: function () {
                        ...
                        t("body").on(
                            ...
                            function (i) {
                                i.preventDefault();
                                var s = t(this);
                                t(".lists .form-comment").remove();
                                var n = s.attr("data-id"),
                                    o = s.attr("data-product"),
                                    r = s.attr("data-name"),
                                    a = e.renderFormReply(o, n, r),
                                    l = s.parentsUntil(".item");
                                s.parents(".comments-reply").length
                                    ? (console.log("list"),
                                      l.parents(".comments-reply").after(a))
                                    : l.append(a);
                            }
                        );
                    },
                    paginationCommentAjax: function () {
                        var e = this;
                        t("body").on("click", ".pagination a", function (i) {
                            i.preventDefault();
                            var s = t(this).attr("href");
                            t(this).addClass("active"), e.getListComments(s);
                        });
                    },
                    getListComments: function (e) {
                        t.ajax({
                            type: "GET",
                            url: e,
                            success: function (e) {
                                t("#list-comment").html(e.html);
                            },
                        });
                    },
                    renderFormReply: function (t, e, i) {
    ...
    Zg5M: function (t, e, i) {
        ...
        !(function (o, r) {
            ...
            var e = {
                ...
                m = c && "classList" in document.createElement("p"),
                g =
                    c &&
                    (function () {
