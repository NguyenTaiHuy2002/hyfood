    ...
    <div class="left">
        <div class="list">
            ...
            <div class="list__content">
                    ...
                    <tbody>
                        @foreach($shopping as $key => $item)
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <span class="js-total-item">{{ number_format($item->price * $item->qty, 0, ',', '.') }}
                                        đ</span>
                                </td>
                            </tr>
                        @endforeach
                ...
                <p style="float: right;margin-top: 20px;">Tổng tiền :
                    <b id="sub-total">{{number_format(rtrim(\Cart::subtotal(0), ',00'), 0, ',', '.') }} đ</b>
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="customer__content">
                <form class="from_cart_register" action="{{ route('post.shopping.pay') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tst_address" id="address" required="" value="{{ get_data_user('web', 'address') }}"
                            type="text" class="form-control">
                    </div>
                    <div class="form-group">
